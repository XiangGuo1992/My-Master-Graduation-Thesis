...
for train, test in loo: 
	...
	ada_discrete.fit(x[train], y[train])
	print(ada_discrete.score(x[test], y[test]))
	result1.append(ada_discrete.score(x[test], y[test]))
	'''
 
	ada_real=AdaBoostClassifier(algorithm='SAMME.R')
	ada_real.fit(x[train], y[train])
	print(ada_real.score(x[test], y[test]))
	result.append(ada_real.score(x[test], y[test]))
